...
def apply_beautygan_filter(origin_img_path_base64, style_img_path_base64):
    try:
        ...
        with tf.compat.v1.Session() as sess:
            ...
            origin_img = align_faces(origin_img_path_base64)
            style_img = align_faces(style_img_path_base64)
            ...
            # Convert the output image to bytes before encoding
            output_img_bytes = output_img.tobytes()
            output_img_base64 = base64.b64encode(output_img_bytes).decode("utf-8")

        return output_img_base64
